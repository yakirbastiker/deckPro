...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nexports.default = function (card) {\n    if (card === 'J' || card === 'Q' || card === 'K') {\n        card = 10;\n    } else if (card === 'A') {\n        card = 11;\n    }\n\n    return card;\n};\n\n//# sourceURL=webpack:///./src/checkCardValue.js?");
...
"use strict";
eval("\n\n__webpack_require__(/*! ./../sass/main.scss */ \"./sass/main.scss\");\n\nvar _Deck = __webpack_require__(/*! ./Deck */ \"./src/Deck.js\");\n\nvar _Deck2 = _interopRequireDefault(_Deck);\n\nvar _checkCardValue = __webpack_require__(/*! ./checkCardValue */ \"./src/checkCardValue.js\");\n\nvar checkCardValue = _interopRequireWildcard(_checkCardValue);\n\nvar _betControl = __webpack_require__(/*! ./betControl */ \"./src/betControl.js\");\n\nvar _betControl2 = _interopRequireDefault(_betControl);\n\nvar _actionControl = __webpack_require__(/*! ./actionControl */ \"./src/actionControl.js\");\n\nvar _actionControl2 = _interopRequireDefault(_actionControl);\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar deck = new _Deck2.default();\n\n//array to push the card \nvar playingUser = ['J', 'A'];\nvar playingDealer = ['J', 'A', 2];\nvar bet = void 0; // the bet in the round\nvar money = 1000;\n(0, _betControl2.default)(money);\n\n(0, _actionControl2.default)();\n\nfunction game() {\n    deck.generateDeck();\n    deck.printDeck();\n    deck.shuffle();\n    deck.deal();\n    console.log(deck);\n}\n\nfunction check21(str) {\n    var num = 0;\n    //check \n    if (str === 'user') {\n        for (var card = 0; card < playingUser.length; card++) {\n            num += checkCardValue(playingUser[card]); // get val of card\n        }\n    } else {\n        for (var _card = 0; _card < playingDealer.length; _card++) {\n            num += checkCardValue(playingDealer[_card]);\n        }\n    }\n\n    if (str === 'user') {\n        if (num > 21) {\n            console.log('user lose over 21');\n            //check if A in hand to change to 1\n        } else if (num === 21) {\n            console.log('user blackjeck');\n        } else {\n            console.log('user keep play');\n        }\n    } else {\n        //dealer\n        if (num > 21) {\n            console.log('dealer lose over 21');\n        } else if (num === 21) {\n            console.log('dealer blackjeck');\n        } else if (num <= 16) {\n            console.log('dealer take more card');\n        } else {\n            console.log('dealer stand over 17 less 21');\n        }\n    }\n    console.log(num);\n}\n\nfunction checkAinHand(str) {\n    if (str === 'user') {} else {}\n}\n// check21(\"user\")\n// check21(\"dealer\")\n\n//# sourceURL=webpack:///./src/game.js?");
